...
This project involves building classification model (XGBoost and MLP Deep Learning) to identifies trend direction(Uptrend adn Downtrend) of stock price as below.
